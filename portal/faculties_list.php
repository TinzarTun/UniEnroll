<?php 
    ...
    recordbrowse("http://localhost/UniEnroll/portal/faculties_list.php");
?>
    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Faculties List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <!-- Faculties List Table Start -->
                <div class="card-box mb-30">
                    <div class="pd-20">
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-blue h4">Faculties List</h4>
                                <p class="mb-0">List of faculties information</p>
                            </div>
                            <div class="pull-right">
                                <a href="faculties.php" class="btn btn-primary btn-sm scroll-click" role="button"><i class="icon-copy ti-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="pb-20">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    for ($i = 0; $i < $count; $i++) 
                                    {
                                        ...
                                        $fid = $data['FacultiesID'];
                                        $name = $data['Name'];
                                        $year = $data['Founded_year'];
                                        $status = $data['Status'];

                                        echo "<tr>";
                                            echo "<td class='table-plus'>$fid</td>";
                                            echo "<td>$name</td>";
                                            echo "<td>$year</td>";
