<?php 
    ...
    recordbrowse("http://localhost/UniEnroll/portal/department_view.php");
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form action="department_view.php" method="post">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="pull-right">
                                <a href="department_list.php" class="btn btn-primary btn-sm scroll-click" role="button">Go Back</a>
                            </div>
                        </div>
                    </form>
                </div>
